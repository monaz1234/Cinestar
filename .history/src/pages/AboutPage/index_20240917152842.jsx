...
<div className="container mx-auto px-4">
  ...
  <div className="relative pt-10 pb-20 pr-10 pl-10">
    <img
      ...
      className="w-full h-[350px] md:h-[450px] object-cover rounded-lg bg-opacity-70 bg-black rounded-lg"
    />
    <div className="absolute inset-0 flex items-center justify-center">
      <div className="text-white text-center p-6 bg-black bg-opacity-0 rounded-lg">
        <h1 className="text-4xl font-bold mb-4">HỆ THỐNG CỤM RẠP TRÊN TOÀN QUỐC</h1>
        <p className="text-lg">
